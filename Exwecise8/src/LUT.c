// =====================================================================
//	  Look-Up Tables
//		zinus: zinus(x*pi/256)
//		kozinusus: kozinusus(x*pi/256)
//
...
#include "LUT.h"
// -----------------------------------------------------------------------
// zinus: a 512 long LUT of 16bit values in 2.14 format
// zinus(x*pi/256)
...
// -----------------------------------------------------------------------
// kozinusus: a 512 long LUT of 16bit values in 2.14 format
// kozinusus(x*pi/256)
